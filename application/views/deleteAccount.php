    ...
    <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      ...
      <div id="page-content-wrapper">
        ...
        <form class="needs-validation" method="post" novalidate>
            ...
            <div class="col-md-2">
              <img src="<?php echo base_url(); ?>assets/img/trash-bin.gif">
            </div>
            </div>
          </form>
          <hr class="dark">
          <form class="needs-validation" method="post" id="delete_form" novalidate>
          ...
          <th scope="col">Personal Photo</th>
            ...
            <th scope="col"><button class='btn btn-primary' type='submit' name='delete'>Delete</button></th>
...
$(document).on({
  ...
  $('#admin').change(function(){
    ...
    {
      $.ajax({
        url:"<?php echo base_url();?>index.php/Check_id_Controller/check_id_delete",
        method:"POST",
        data:{admin:admin},
  ...
  $('#delete_form').submit(function(e) { 
    ...
    {
		$.ajax({
			url: "<?php echo base_url();?>index.php/DeleteAccountController/process",
			type: "POST",
			cache: false,
			data:{admin:admin},
			success: function(data){
