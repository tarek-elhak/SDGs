      ...
      <div id="page-content-wrapper">
        ...
        <?php if($this->session->flashdata('add')){?>
          ...
          <form class="needs-validation" method="post"  novalidate>
            <div class="formf row">
              <h2>Add Admin Account Form</h2>
            <div class="col-md-2">
              <img src="<?php echo base_url(); ?>assets/img/add-folder.gif">
            </div>
            </div>
          </form>
          <hr class="dark">
          <?php echo form_open_multipart("AddAccountController/process");?>
            <form class="needs-validation" method="post" name="form" enctype="multipart/form-data" novalidate>
              <div class="fromrow form-row">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <div class="input-group">
                    <label type="button" class="btn btn-light" style="border:1px solid; color:white; border-color:#2C3E50; background-color: #3b6b7c; margin-top:0px; width:130px; height:38px;">
                      Select Photo    
              ...
              <div class="fromrow form-row">
                ...
                <div class="col-md-12 mb-12">
                  <button class="btn btn-primary" type="submit" name="add" id="add">Add Account</button>
                </div>
              </div>
...
$(document).ready(function(){
  $('#email').change(function(){
    ...
    {
      $.ajax({
        url:"<?php echo base_url();?>index.php/CheckEmailController/check_Email",
        method:"POST",
        data:{email:email},
